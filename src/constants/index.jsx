...
import { FileText, Camera, Brush, Music, Globe, ShoppingCart } from "lucide-react"; 
...
export const features = [
  {
    ...
    description: "Graphic Design, Visual Design, Audio Production, Proposals & Presentations",
  },
  {
    icon: <Camera />,  
    text: "Media Production",
    href: "/components/photography",
    description: "Event Coverage, Promotional Videos, Testimonial Videos, Corporate AVs, Custom Video Production, Live Streaming",
  },
  {
    icon: <Brush />, 
    text: "Graphics Services",
    href: "/components/Graphics",
    description: "Social Media Posts, Print Design Materials, Product Photography for E-Commerce, Custom Designs",
  },
  {
    icon: <Music />,  
    text: "Audio Services",
    href: "/components/Audio",
    description: "Dubbing, Recording, Music Production, Podcast Creation",
  },
  {
    icon: <Globe />, 
    text: "Website & App Development",
    href: "/components/Web",
    description: "We offer both static and dynamic website solutions, along with customized web and app development services tailored to your brand’s needs.",
  },
  {
    icon: <ShoppingCart />,  
    text: "Social Media & E-Commerce Integration",
    href: "/components/ecom",
    description: "Expand your digital footprint with our full suite of e-commerce services, E-Commerce Platform Registration, Campaign Management",
  },
];
...
export const pricingOptions = [
  ...
  },
  {
    title: "Standard",
    category: "trial",
    features: ["Daily social media posting (up to 5 platforms)",
  ...
  },
  {
    title: "Premium",
    category: "trial",
    features: ["Daily social media posting (up to 9 platforms)",
      "Weekly analysis report",
      "Content production",
      "6 promo videos",
  ...
  },
  {
    title: "Enterprise",
    category: "enterprise",
    features: ["Full coverage across all platforms and basic e-commerce support",
      "Weekly analysis report",
  ...
  },
  {
    title: "Custom",
    category: "enterprise",
    features: ["Fully customized plan designed to meet your specific business needs"],
  },
